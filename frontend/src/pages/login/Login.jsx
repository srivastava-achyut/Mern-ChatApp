...
const Login = () => {
    ...
    return (
        <div className='flex flex-col items-center justify-center min-h-screen'>
            <div className='w-full max-w-md p-8 rounded-lg shadow-2xl bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0 border border-slate-700'>
                ...
                <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
                    ...
                    <div className='text-center mt-2'>
                        <Link to='/signup' className='text-sm text-gray-300 hover:text-sky-400 hover:underline transition-all inline-block'>
                            {"Don't"} have an account? Sign up
                        </Link>
                    </div>
